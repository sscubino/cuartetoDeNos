...
\begin{addmargin}[4em]{0em}
	\auxpred{respetaProfundidad}{s :\TLista{\ent}, prof :\ent}{\\
		(\forall i :\ent)( entre(0,i,|s|) \implicaLuego entre(-2^{prof-1}, s[i], 2^{prof-1})\\
	}
\end{addmargin}
\vspace{1cm}
...
\begin{addmargin}[4em]{0em}
	\begin{proc}{seEnojó?}{\In señal :\TLista{\ent}, \In umbral:\ent, \In prof:\ent, \In freq:\ent, \Out b :\bool}{}
		\pre{esSe\tilde{n}alValida(se\tilde{n}al,prof,freq) \y entre(-2^{prof-1}, umbral, 2^{prof-1})}
		\post{ \\
...
\begin{addmargin}[4em]{0em}
	\auxpred{incluida}{s :\TLista{\ent}, subseq :\TLista{\ent}}{\\
		(\exists i :\ent)(entre(0, i, |s|-|subseq|+1) \yLuego \\
		(\forall j :\ent)(entre(0, j, |subseq|) \implicaLuego subseq[j]=s[j+i])) \\
	}
\end{addmargin}
\vspace{1cm}
...
\begin{addmargin}[4em]{0em}
	\auxpred{superaUmbral}{s :\TLista{\ent}, umbral :\ent}{\\
		(\forall i :\ent)(entre(0, i, |s|) \implicaLuego s[i]>umbral) \\
	}
\end{addmargin}
...
\begin{addmargin}[4em]{0em}
	\auxpred{todasSonSe\tilde{n}ales}{\In r :reunion}{
		(\forall i:\ent)(entre(0,i,|r|)\implicaLuego esSe\tilde{n}alValida[i]_{0})
		}
\end{addmargin}
\vspace{1cm}
...
\begin{addmargin}[4em]{0em}
	\auxpred{muestrasDeIgualTama\tilde{n}o}{\In r :reunion}{\\
		(\forall i :\ent)(entre(0, i, |r|) \implicaLuego |(r[0])_0| = |(r[i])_0| \\
	}
\end{addmargin}
\vspace{1cm}
...
\begin{addmargin}[4em]{0em}
	\auxpred{unaSe\tilde{n}alPorPersona}{\In r :reunion}{\\
		(\forall i :\ent)(\forall j :\ent)(entre(0, i, |r|) \y entre(0, j, |r|) \y i \neq j \implicaLuego(\\
